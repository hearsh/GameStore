...
<div id="main-content-section" data-magellan-target="main-content-section">
  <div class="grid-x grid-container rown grid-padding-x">
    <div class="cell">
    <h2 class="center">Recomended for you</h2>
    <hr class="center-ball" />
  </div>
<div class="cell medium-4 " ng-repeat="x in topProducts">
<div class="card card-product">
  <div class="card-product-img-wrapper">
    <a ng-click="addCart(x.product_id, $index)" class="button expanded">Add to Cart</a>
    <a ><img src="api/{{x.image}}"></a>
...
<div class="image-hover-wrapper">
  <span class="image-hover-wrapper-banner">Games</span>
  <a href="games.php"><img src="img/games.jpeg">
    <span class="image-hover-wrapper-reveal">
      <p>Check it<br><i class="fa fi-link" aria-hidden="true"></i></p>
    </span>
  </a>
</div>
</div>
...
<div class="cell medium-4 ">
<div class="image-hover-wrapper">
  <span class="image-hover-wrapper-banner">Accessories</span>
  <a href="accessories.php"><img src="img/accessories.jpeg">
    <span class="image-hover-wrapper-reveal">
      <p>Check it<br><i class="fa fi-link" aria-hidden="true"></i></p>
    </span>
  </a>
...
<div class="cell medium-4 ">
<div class="image-hover-wrapper">
  <span class="image-hover-wrapper-banner">Console</span>
  <a href="console.php"><img src="img/console.jpeg">
    <span class="image-hover-wrapper-reveal">
      <p>Check it<br><i class="fa fi-link" aria-hidden="true"></i></p>
    </span>
  </a>
